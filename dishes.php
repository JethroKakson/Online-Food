        ...
        <div class="page-wrapper">
            ...
            <div class="container m-t-30">
                <div class="row">
                    <div class="col-md-8" style="width: 100%;">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                ...
                                <?php echo $rows['title']; ?> <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-3" style="width: 100%;">
